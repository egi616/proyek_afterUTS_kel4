<!-- halaman utama yang didedikasikan untuk member; -->
<?php
session_start();
...
<body>
    ...
    <section class="py-5 bg-white">
        <div class="container">
            ...
            <div class="row g-4">
                <!-- perulangan untuk menampilkan buku -->
                            ...
                            <div class="card-footer text-end">
                                <?php if (isset($_SESSION['id'])): ?>
                                    ...
                                    <button class="btn btn-sm btn-success"
                                        ...
                                        onclick="isiFormPinjam('<?= $book['id']; ?>','<?= $book['title']; ?>')">
                                        Borrow
                                    </button>
                                <?php else: ?>

                                    <!-- Kalau maka tidak akan bisa pinjam buku-->
                                    <a href="modules/auth/login.php"
                                        class="btn btn-sm btn-secondary"
                                        onclick="return confirm('Anda harus login dulu untuk meminjam buku!')"> 
                                        Borrow
                                    </a>
                                <?php endif; ?>
                            </div>
